...
public class DateModelTests {
  ...
  @Test
  public void Feb29_2000_Tuesday() {
    DateModel.initialize("2000", "2", "29");
    assertThat(DateModel.getMessage(), is("Tuesday"));
  }

  @Test
  public void invalidNegativeMonth() {
    DateModel.initialize("2022", "-9", "12");
    assertThat(DateModel.getMessage(), is("Invalid month"));
  }

  @Test
  public void improperDateFormat() {
    DateModel.initialize("2022", "1", "1.67");
    assertThat(DateModel.getMessage(), is("Enter values in a proper numeric format"));
  }
}